...
@Composable
fun HomeScreen(userId: String, onSelectSchool: (String) -> Unit) {
                    ...
                    items(createdSchools) { s ->
                        ElevatedCard(
                            ...
                            Column(Modifier.padding(16.dp)) {
                                Text(s.school_name ?: "School", style = MaterialTheme.typography.titleMedium)
                                s.description?.let { Text(it, style = MaterialTheme.typography.bodyMedium) }
                            }
                        }
                    }
                }
